    ...
    function(response) {
      ...
      if (doctors.data.length == 0) {
        (".doctor_result").append(
          "Sorry, there are no doctors that fit the entered data"
        );
      } else {
        doctors.data.forEach(function(doctor) {
          function yesOrno(response) {
            ...
            if (response == true) {
              ...
              answer ==
                "No, we are sorry but they are not accepting any new patients at this time.";
            }
            return answer;
          }
          const acceptingNewPatients = yesOrno(
